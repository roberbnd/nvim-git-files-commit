...
local function open_window()
  ...
  api.nvim_buf_set_option(buf, 'filetype', 'gitfiles')
  ...
  api.nvim_buf_add_highlight(buf, -1, 'GitFilesCommitHeader', 0, 0, -1)
end
